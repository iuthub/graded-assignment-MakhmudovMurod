    ...
    <body>
        ...
        <form action="{{ route('tasks.store') }}" method="POST">
            ...
            <div id="myDIV" class="header">
              <h2>My To Do List</h2>
              <input type="text" name="task_name" placeholder="Title..." >
              <button type="submit" class="addBtn" name="submit">Add</button>
            </div>
        </form>


        {{-- Displaying Stored tasks --}}
            ...
            <ul id="myUL">
                ...
                @foreach($storedTasks as $storedTask)
                    <li>
                        ...
                        <div class="action">
                            <a href="{{ route('tasks.edit',['task'=>$storedTask->id]) }}" class="btn btn-primary">Edit</a>
                        </div>
                        ...
                        <div class="action">
                            <form action="{{ route('tasks.destroy',['task'=>$storedTask->id]) }}" method="POST">
                                ...
                                <input type="submit" class="btn btn-primary" style="padding-right:40px;" value="Delete">
                            </form>
                        </div>
